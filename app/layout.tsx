...
export default function RootLayout({
  ...
  return (
    <html lang="en" className={`${inter.variable} ${fredoka.variable} ${poppins.variable}`}>
        ...
        <ThemeProvider>
          <OrderProvider>
            <div className="min-h-screen bg-gradient-to-br from-red-50 via-orange-50 to-yellow-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 transition-colors duration-300">
              <div className="fixed inset-0 bg-gradient-to-br from-red-100/20 via-orange-100/20 to-yellow-100/20 dark:from-red-900/10 dark:via-orange-900/10 dark:to-yellow-900/10 pointer-events-none transition-colors duration-300" />
              <Header />
              ...
              <div className="fixed bottom-6 right-6 z-50">
                <a
                  href="https://wa.me/919559545103?text=Hi! I want to know more about Burger Games menu and offers."
                  target="_blank"
